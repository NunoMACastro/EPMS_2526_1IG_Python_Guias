...
## 12. Remover cache do Git

Por vezes é necessário remover ficheiros do controlo do Git sem os apagar do disco. Por exemplo, quando adicionamos ficheiros ao .gitignore depois de já terem sido adicionados ao repositório.
Para isso, usamos o seguinte comando:

```bash
git rm -r --cached .
git add .
git commit -m "Remover ficheiros do controlo do Git"
```
...
## 14. Fluxo Recomendado para Alunos
